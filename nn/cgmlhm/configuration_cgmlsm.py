...
CgmGpt_PRETRAINED_CONFIG_ARCHIVE_MAP = {}


class CgmLsmConfig(PretrainedConfig):
    model_type = "cgmlsm"
    ...
    def initalize_field_info(self):
        ...
        self.vocab_size = len(tkn2tid)
        self.bos_token_id = tkn2tid['[BOS]']
        self.eos_token_id = tkn2tid['[EOS]']
        self.pad_token_id = 0
    ...
    def to_dict(self):
        ...
        fields_to_exclude = ['CF_to_CFvocab', 
                             'target_field_vocab', 
                             'OneEntryArgs']
...
class CgmLsmOnnxConfig(OnnxConfigWithPast):
    def __init__(
        self,
